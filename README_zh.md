...
│   ├── core-domain/       # 共享领域类型
│   ├── driver-api/        # 数据库驱动抽象
│   ├── driver-mongodb/    # MongoDB 驱动
│   ├── driver-mysql/      # MySQL 驱动
│   ├── driver-postgres/   # PostgreSQL 驱动
│   ├── export-service/    # CSV、Excel、SQL 和 MongoDB 导出
│   ├── history-store/     # 查询历史
│   ├── i18n/              # 国际化（中文 / 英文）
│   ├── secure-store/      # 凭证存储
